...
#command = "sudo su; cp -r /home/airflow/.local/lib/python3.7/site-packages/* /usr/local/lib/python3.7/dist-packages/"
command = " sudo chown -R airflow: /usr/local/lib/python3.7/dist-packages; pip install apache-airflow-providers-apache-beam --target /usr/local/lib/python3.7/dist-packages/"
